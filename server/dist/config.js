...
const config = {
    ...
    upload: {
        tempDir: process.env.UPLOAD_TEMP_DIR || path_1.default.join(process.cwd(), 'uploads'),
        maxFileSize: parseInt(process.env.MAX_FILE_SIZE || '10485760', 10)
    },
    // Keep uploadDir for backward compatibility
    uploadDir: process.env.UPLOAD_TEMP_DIR || path_1.default.join(process.cwd(), 'uploads'),
    maxFileSize: parseInt(process.env.MAX_FILE_SIZE || '10485760', 10),
    // JWT configuration
    jwt: {
